...
text = 'Уважаемые кураторы! По кнопке "Мои участники" в вашем меню доступны результаты выших участников. Ваше меню выделено смайликом 👨‍🏫 в кнопках основного меню.'
